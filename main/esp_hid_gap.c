...
static uint8_t *stored_addr = NULL;
...
esp_err_t esp_hid_scan(uint32_t seconds, size_t *num_results,
                       esp_hid_scan_result_t **results, uint8_t *st_addr) {
...
void print_esp_hid_scan_results(esp_hid_scan_result_t *r) {
  printf("esp hid scan results:\n");
